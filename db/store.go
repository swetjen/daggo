...
type Store interface {
	...
	RunFilteredCount(context.Context, RunFilteredParams) (int64, error)
	RunGetManyJoinedJobs(context.Context, RunGetManyJoinedJobsParams) ([]RunGetManyJoinedJobsRow, error)
	RunFilteredGetMany(context.Context, RunFilteredParams) ([]RunGetManyJoinedJobsRow, error)
	RunWindowGetMany(context.Context, RunWindowParams) ([]RunGetManyJoinedJobsRow, error)
	RunCursorGetMany(context.Context, RunCursorParams) ([]RunGetManyJoinedJobsRow, error)
